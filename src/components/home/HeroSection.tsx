            ...
            <div className="relative z-10 w-full aspect-square max-w-md mx-auto">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative w-96 h-96">
                  ...
                  <motion.div 
                    className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 rounded-xl overflow-hidden backdrop-blur-sm cursor-pointer"
                    whileHover={{ 
                      scale: 1.15,
                      rotateY: 10,
                  ...
                  >
                    <div className="relative w-full h-full group">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-r from-primary-500/20 to-accent-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-400"></div>
                      
                      {/* Band image */}
                      <img 
                        src="\safety-band.png" 
                        alt="Sanjeevani Safety Band" 
                        className="w-full h-full object-contain transform group-hover:scale-105 transition-transform duration-400"
                      />
                      
                      {/* Hover overlay */}
                      <div className="absolute inset-0 bg-dark-900/40 opacity-0 group-hover:opacity-100 transition-opacity duration-400"></div>
                      
                      {/* Pulsing border */}
                      <div className="absolute inset-0 border-2 border-primary-500/50 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-400">
